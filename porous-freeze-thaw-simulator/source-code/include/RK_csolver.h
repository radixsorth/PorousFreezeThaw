...
one passed to RK_c_init(). Before RK_c_solve() can be called to carry out the calculation, both of the
following must be ready:
1) The sover must be initialized by a call to RK_c_init()
