...
* file: RK_MPI_SAsolver_hybrid2.c                               *
\***************************************************************/
...
This version parallelizes the OUTER LOOPS OVER THE CHUNK ARRAY when calculating
the coefficients Ki. Use this version if your system has a large amount
of relatively small chunks.
*/
...
#endif
/* this macro must be defined manually when the compiler is CpenMP 3.1 compliant */
#ifdef __OPENMP31
